...
const RequestPage = () => {
    ...
    const itemsPerPage = 8; // ৪ কলাম গ্রিডের জন্য ৮ বা ১২টি কার্ড দেখতে দারুণ লাগে
    ...
    const handleSearchSubmit = async (filters) => {
        ...
        fetchRequests(filters, 1); // নতুন সার্চে সবসময় ১ নম্বর পেজ থেকে শুরু হবে
    };
    ...
    return (
        <section className="w-full bg-pink-100/40 pb-20 px-4 sm:px-6 font-inter">
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                {/* 🌟 মডিফাইড সার্চ ফিল্টার এখানে কল করা হলো */}
                ...
                {loading ? (
                    ...
                    <>
                        {/* 🌟 রিকোয়েস্ট কার্ড রেসপনসিভ গ্রিড ভিউ */}
                                ...
                                {[...Array(totalPages)].map((_, idx) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-10 h-10 rounded-xl text-sm font-bold font-poppins transition-all ${
                                                currentPage === pageNum
